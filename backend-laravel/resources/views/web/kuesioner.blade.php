...
<div class="wizard-container">
    <div class="page-header anim-fade"><h1>Kuesioner Analisis</h1><p>Jawab 13 pertanyaan tentang gaya hidup digitalmu</p></div>
    ...
    <form method="POST" action="{{ url('/user/kuesioner') }}" id="kuesionerForm">
        ...
        <div class="wizard-page" id="step1">
            ...
            <div class="q-block"><label class="form-label">1. Perangkat utama yang kamu gunakan?</label>
            <div class="opt-group" data-name="device_type">
                @foreach(['Smartphone' => 'HP / Tablet', 'Laptop' => 'Laptop / Notebook', 'Both' => 'Smartphone & Laptop'] as $val => $sub)
                <div class="opt-card {{ old('device_type')==$val?'selected':'' }}" data-value="{{ $val }}"><div class="opt-radio"></div><div><div style="font-weight:700;">{{ $val }}</div><div style="font-size:.8125rem;color:var(--text-muted);">{{ $sub }}</div></div></div>
                @endforeach
            </div>
            <input type="hidden" name="device_type" value="{{ old('device_type') }}"></div>

            <div class="q-block"><label class="form-label">2. Berapa lama menggunakan perangkat per hari?</label>
            ...
            <div class="q-block"><label class="form-label">3. Berapa kali membuka HP per hari?</label>
            ...
            <div class="q-block"><label class="form-label">4. Jumlah notifikasi per hari?</label>
            ...
            <div class="q-block"><label class="form-label">5. Waktu media sosial (menit/hari)</label>
        ...
        <div class="wizard-page hidden" id="step2">
            ...
            <div class="q-block"><label class="form-label">6. Waktu belajar per hari (menit)</label>
            ...
            <div class="q-block"><label class="form-label">7. Olahraga berapa hari per minggu?</label>
            ...
            <div class="q-block"><label class="form-label">8. Durasi tidur per malam?</label>
            ...
            <div class="q-block"><label class="form-label">9. Kualitas tidur (1–5)</label>
        ...
        <div class="wizard-page hidden" id="step3">
            ...
            <div class="q-block"><label class="form-label">10. Tingkat kecemasan (0–27)</label>
            ...
            <div class="q-block"><label class="form-label">11. Skor depresi (0–27)</label>
            ...
            <div class="q-block"><label class="form-label">12. Tingkat stres (1–10)</label>
            ...
            <div class="q-block"><label class="form-label">13. Skor kebahagiaan (0–10)</label>
